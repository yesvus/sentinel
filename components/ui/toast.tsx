...
/** Fired whenever a toast is added, so the notification bell can keep a history of them. */
export const TOAST_HISTORY_EVENT = "sentinel-toast-history"
...
const toast: typeof baseToastManager = {
  ...baseToastManager,
  add(options) {
    const id = baseToastManager.add(options)
    ...
    window.dispatchEvent(new CustomEvent<ToastHistoryEntry>(TOAST_HISTORY_EVENT, { detail: entry }))
    return id
  },
}
